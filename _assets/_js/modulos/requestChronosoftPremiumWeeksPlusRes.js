$(document).ready(function(e)
{
    ...
    $("#popsito").on("click",function(event) {
        ...
        if ($('#lastMinute')[0].checkValidity() === false) {
	        ...
	        {
                var demo1 = '<link href="_assets/_css/css/popupInventarioRegina.css?x=<?php echo(rand()); ?>" type="text/css" rel="stylesheet">'+
			...
			{
				var demo2 = '<link href="' + pathname + '/_assets/_css/css/popupInventarioRegina.css?x=<?php echo(rand()); ?>" type="text/css" rel="stylesheet">'+
				'<div id="InventarioRegina" class="modal chrono-modal">'+
