...
$(document).ready(function(e) {
	...
	/*	if($("#cvv").val()=="" || vacioReg.test($("#cvv").val()) || isNaN($("#cvv").val()))
		...
		if(ban)
		{
			...
			var respuesta = $.post("_assets/_controllers/envioInventarioRegina.php",
			{
				nombre:$("#nombre").val(),
			...
			respuesta.done(function(data){
				...
				{
					$("#idEnvio2").css("display","block");
					$("#idEnvio2").removeClass("accep");
					$("#idEnvio2").addClass("error");
					$("#idEnvio2").html(idioma.formulario.mensajeerror);
...
$(document).on("click","#tachapop",function(){
	$("#idEnvio").hide();
});