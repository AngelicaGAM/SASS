...
$(document).ready(function(e) {
	...
	$("#send").on("click",function(){
		...
		if(!emailReg.test($("#email").val()))
		{
				...
				//$("#errorEmail").html(idioma.formulario.campo14Valida);	
				listaErrores += idioma.formulario.campo14Valida + "<br/>";
				ban=false;
		}
		if(!digitsReg.test($("#phone").val()))
		{
				//$("#errortel").css("display","block");
				//$("#errortel").html(idioma.formulario.campo15Valida);
				listaErrores += idioma.formulario.campo15Valida + "<br/>";
				ban=false;	
		}
		/*
		...
		*/
		if($("#locacion").val()=="" || vacioReg.test($("#locacion").val()) )
		{
				//$("#errorLocacion").css("display","block");
				//$("#errorLocacion").html(idioma.formulario.campo11Valida);	
		...
		if( $("#fecha").val()=="" )
		{
				...
				//$("#errorFecha").html(idioma.formulario.campo12Valida);	
		...
		if(ban)
		{
			...
			var respuesta = $.post("../../_assets/_controllers/envioCarros.php",
			{
				nombre:$("#nombre").val(),
