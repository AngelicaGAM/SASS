...
$(document).ready(function(e) {
	 $('.sliderContent').revolution(
		...
		$("#fechaIn, #fechaOut" ).datepicker({minDate:hoy,dateFormat:"dd/mm/yy" });
	...
	$("#send").on("click",function(){
		...
		if($("#resort").val()=="Resort name" || $("#resort").val()=="" || vacioReg.test($("#resort").val()))
		{
				$("#errorResort").css("display","block");
				$("#errorResort").html('Type a tour name');	
				ban=false;
		}		
		...
		if(ban)
		{
			...
			var respuesta = $.post("_assets/_controllers/envioDeals.php",
			{
				nombre:$("#nombre").val(),
