				...
				if(data=="ok") {
					...
					$.fancybox(
						...
						'<div id="InventarioRegina" class="modal chrono-modal">'+
							...
							'<div class="fondopopup">'+
								'<!--<span class="titulopop">Dear member,</span>-->'+
								'<span class="parrafopop">Rates in other currencies are approximate and for informative purposes. The final credit card will be charged in US Dollars. The exchange rate will be established by the different banking institutions at the moment of payment.</span>'+
							'</div>'+
						'</div>', {
							'autoDimensions': false,
							'width': 350,
					...
					$.fancybox(
						...
						'<div id="InventarioRegina" class="modal chrono-modal">'+
							...
							'<div class="fondopopup">'+
								'<!--<span class="titulopop">Dear member,</span>-->'+
								'<span class="parrafopop">There was a problem at the time of the exchange, try again or reload your page.</span>'+
							'</div>'+
						'</div>', {
							'autoDimensions': false,
							'width': 350,
