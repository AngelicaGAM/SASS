			  ...
			  type:"POST",
					 data:{
						...
						if(aux[0]=="ok")
						{
							...
							if(aux[1]=="rechazo") {
								$("#errorTarjeta").show();
								/* Se ejecuta pop-up de error en el pago para que se comuniquen con el banco*/
								/*$.fancybox({
									'type': 'iframe',
									'href': 'https://members.beyond-experience.com/_assets/_popup/errorPago.php',
							...
							if( aux[1] == "chronosoft" ) {
								$( "#errorChronosoft" ).show();
								$( "#chronoCode" ).html( aux[2] );
							}
							if( aux[1] == "disponibilidadChrono" ) {
	                            $( "#disponibilidadChrono" ).show();
	                        }
							if(aux[1]=="")
							{
								//alert("eror valioda");
								$("#errorProceso").show().html("The reservation could not be completed please contact your concierge");
								console.log("dispara pop");
								pathname = "https://members.beyond-experience.com";
								$.fancybox('<link href="' + pathname + '/_assets/_css/popupInventarioRegina.css?x=<?php echo(rand()); ?>" type="text/css" rel="stylesheet"><div id="InventarioRegina" class="modal chrono-modal"><div class="fullin colorlogo"><img class="logopopregina" src="' + pathname + '/_assets/_images/template/logo-1000.png"/></div><img class="fullin tira" src="' + pathname + '/_assets/_images/popupInventarioRegina/cintillo.jpg"/><div class="fondopopup"><span class="parrafopop">Dear member,<br>At the moment we are unable to process your payment. <br> Please contact your Personal Concierge to conclude your reservation process. <br></span><div class="centerpop"><div class="iblockpop w70"><span class="numerospop"> </span></div></div></div></div>', {
			'autoDimensions': false,
			'width': 350,
			'height': 'auto',
			'transitionIn': 'none',
