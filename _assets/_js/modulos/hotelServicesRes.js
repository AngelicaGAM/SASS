...
models.hotelesMap = "";
models.maquetaActual="";
models.hotels=`<div id="hotelito_{id}" class="contenedorHotelesBusqueda animated fadeIn {encontrado}">
<div id="hotel_0" class=" row contenedor_interno hotel">
    <div class="col col-12 col-md-3 contenidoImagen effect2">
            {descuento}
            <img class="masInformacion" src="{imagen}" onerror="models.imagenesDefault(this);" alt="{name}" data-val="{id}" data-url="galeria">
            <div class="estrellasHotel">{estrellas}</div>
       
    </div>
    <div class="col col-12 col-md-5  contenedor_informacion contprin">
        <div class="contenedor_informacion_centro">
            <div class="contentDes">
                <div class="header">
                    ...
                    <div class="titles">
                        <span class="DestinoL"><i class="fa fa-map-marker" aria-hidden="true"></i> {destino} </span>
                        <span class="fechas">`+idioma.comparador.fechas+` {fechas} </span>
                    </div>
                </div>
           
                <div class="descrip" data-val="{id}" data-url="informacion">{HotelDescription}</div>
            </div>
           
        </div>
    </div>
    <div class="col col-12 col-md-4   contenedor_precio">
          
        <div class="informacionPrecios">
            <div class="tituloPrecios">              
                {nuevoPrecio}
                <div class="night"><span>Per night</span>
                    <span>`+divisa.simbolo+`  {precioPorNoche}  `+divisa.moneda+`</span>
                </div>
                {save}
                <div class="public naranja"><span> Member’s Price </span> <span class="izq">{precioSocio} </span></div>
		</div>
		<div class="verDetallesH info btabs{id}" data-val="{id}" data-url="tarifasRes" data-accion="show" data-tabs="{dataTabs}"><i class="fa fa-search" aria-hidden="true"></i></div>
        </div>{tooltipXDXDXD}
    </div>
</div>
<div class="ultratabs" id="ultratabs{id}">
    <div class="nombreTab"><i class="fa fa-arrow-left" aria-hidden="true"></i> {name} </div>
    <span class="fechasTab">`+idioma.comparador.fechas+` {fechas} </span>
    <div class="menuHotels">
	 <span class="bookHe">Book here!</span>
        <ul class="tabs">
            ...
            <li id="b{id}tarifasRes" class="btabstab info btabs{id}" data-val="{id}" data-url="tarifasRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.buscador.cuartos+`</li>
            ...
            <li id="b{id}galeriaRes" class="btabstab info btabs{id}" data-val="{id}" data-url="galeriaRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.galeria+`</li>
	 ...
	 <!-- <div class='example-one'>
		<div class='example-one-header scroll scroll{id} tabs'>
			<span id="b{id}informacion" class='nav-item btabstab info btabs{id}'  data-val="{id}" data-url="informacion" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.info+`</span>
			<span id="b{id}tarifasRes" class='nav-item btabstab info btabs{id} activoRes' data-val="{id}" data-url="tarifasRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.buscador.cuartos+`</span>
			<span id="b{id}ubicacion" class='nav-item btabstab info btabs{id} ' data-val="{id}" data-url="ubicacion" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.locacion+`</span>
			<span id="b{id}galeriaRes" class='nav-item btabstab info btabs{id} ' data-val="{id}" data-url="galeriaRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.galeria+`</span>
		</div>
	</div>-->
    </div>
    <div id="working{id}" class="working" style="display:none;">
	  <img src="` + pathname + `/_assets/_images/GIF_CARGADOR_eng.gif" class="img-fluid img-fluid d-none d-lg-block"/>
	  <img src="` + pathname + `/_assets/_images/GIF_CARGADOR_MOVIL_ENG.gif" class="img-fluid img-fluid  d-block d-lg-none"/>
	  <span class="parpadea">`+idioma.comparador.parpadea+`</span>
	  <div class="NumerosTel">
		  <p>toll free numbers</p>
		  <div class="tollNumbers">
			  <div class="itemTollNumbers">
				<h4>U.S.A /CANADÁ</h4>
				<a>1-888-963-7689</a>
			  </div>
			  <div class="itemTollNumbers">
    ...
    <div id="mostrar{id}" class="mostrar"></div>
</div>
</div>`;
models.maquetaActual=models.hotels;
models.hotelsDirectorio=`<div id="hotelito_{id}" class="contenedorHotelesBusqueda animated fadeIn {encontrado}">
<div id="hotel_0" class="contenedor_interno hotel">
    ...
    <div class="col col-12 col-md-7  contenedor_informacion contprin">
	<div class="contenedor_informacion_centro">
		<div class="contentDes">
			<div class="header">
			<div class="titles">
			...
			<div class="titles">
				<span class="DestinoL"><i class="fa fa-map-marker" aria-hidden="true"></i> {destino} </span>
				<span class="fechas">`+idioma.comparador.fecha+` {fechas} </span>
			</div>
			</div>
	...
	<div class="col col-12 col-md-2   contenedor_precio">
...
<div class="ultratabs" id="ultratabs{id}">
    <div class="nombreTab"><i class="fa fa-arrow-left" aria-hidden="true"></i> {name} </div>
    <span class="fechasTab">`+idioma.comparador.fecha+` {fechas} </span>
    <div class="menuHotels">
	 <span class="bookHe">Book here!</span>
        <ul class="tabs">
            <li id="b{id}informacion" class="btabstab info btabs{id}" data-val="{id}" data-url="informacion" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.info+`</li>
...
models.hotelMap = `<div class="contenedorX">
						<div id="basic_information">
							...
							<div class="fechasMaps">{fechas}</div>
					            {mapPrecioPublico}
					            {mapUstedAhorra}
					            {mapMemberPrice}
							<span  id="map-b{id}tarifas" class="btn_showInformation  info btabs{id}" onclick="models.showMoreInformation()" data-val="{id}" data-url="tarifasRes" data-accion="show" data-tabs="{dataTabs}" style="">`+idioma.comparador.verdetalles+`</span>
					...
					<div id="popup_hotel" style="display:none">													
						<div id="hotelito_{id}" class="containerHotelSearch animated fadeIn">
							<div id="hotel_0" class="container_interno hotel_search" style="display: none">
								<div class="content_image effect2">
									<div>
										<div class="discount"></div>
										<div class="discount2">
										...
										<div class="header">
											<div class="titles">
												...
												<div class="liston_pop base-liston_pop">
													<div  class="text"> 
														<span class="sub" style="font-size: 14px;">${divisa.simbolo}</span> <span style="font-size:`+fontSize+`;"> {precioPorNoche}</span> <span class="top" style="font-size: 10px;vertical-align: super;">`+divisa.moneda+`</span>
							...
							<div class="ultratabs" id="map-ultratabs{id}">
								...
								<span class="bookHe">Book here!</span>
									<ul class="tabs">
										...
										<li id="map-b{id}tarifas" class="btabstab info btabs{id}" data-val="{id}" data-url="tarifasRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.buscador.cuartos+`</li>
										<li id="map-b{id}galeria" class="btabstab info btabs{id}" data-val="{id}" data-url="galeriaRes" data-accion="show" data-tabs="{dataTabs}">`+idioma.comparador.galeria +`</li>
										<!--<li class="btabstab info" data-val="{id}" data-url="ultratabs" data-accion="hide" data-tabs="{dataTabs}">`+idioma.comparador.cerrar+`</li>-->
										
									</ul>
								</div>
								<div id="map-working{id}" class="working map-working{id}" style="display:none;">
								<span class="parpadea">`+idioma.comparador.parpadea+`</span>
								<div class="NumerosTel">
									<p>toll free numbers</p>
									<div class="tollNumbers">
...
{
	var maxrooms = 0;
	var totalrooms = $("#rooms").val();
	var agrega = $(this).data("cantroom");
	var totAdult =   parseFloat($("#numAdult").val());

	if(totalrooms < 3){
		var agregatotal = parseInt(agrega)+parseInt(totalrooms);				
		maxrooms = agregatotal; 
		$("#rooms").val(agregatotal);
		if(totalrooms >= 1){
			$("#numAdult").val(totAdult+2)
		}
	...
	if (maxrooms > 0) 
	{
		...
		{ 
			...
			$(".room_"+ a,"#habitaciones").hide();
			$(".room_"+ a,"#habitaciones").remove();
		}

		for(var a=2; a<=maxrooms; a++)
		{ 
			var years="";
			for (var j = 1; j < 13; j++) {
				years+='<option value="'+j+'">'+j+' '+(j==1?idioma.buscador.titulo9:idioma.buscador.titulo10)+'</option>';
			}
			$("#habitaciones").append(
			

				`<div class="roomsAdd habitacion room_` + a + ` " id="habitacion_` + a + `" style="display:none">
					  <div class="tituloRoomItem">
					 	 <span>Room ` + a + `</span>
						  <div class="eliminar" >Delete </div>
						  
					  </div>					  
				   	<div class="dropdown-divider"></div>
					<div class="itemRowRoom">
						<div class="itemRowRoom-item">
							<span>Adults</span>
							<small>Children (0-12 years)</small>
						</div>
						<div class="itemRowRoom-item">
							<input type="hidden" class="habitacion`+a+`" value="`+a+`">
							<div class="input-group input-numeric">
								<div class="input-group-prepend">
								<div class="btn " id="minus-btn" onclick="lessOne('#adultos_`+a+`')"><i class="fa fa-minus fa-less-icon" ></i></div>
								</div>
								<div class="line-2"></div>                                                                        
								<input type="number" id="adultos_`+a+`" name="r`+a+`a" class="form-control caja-number" value="2" min="1" max="4" readonly="">
								<div class="line-2"></div>
								<div class="input-group-prepend">
								<div class="btn " id="plus-btn" onclick="plusOne('#adultos_`+a+`')"><i class="fa fa-plus fa-plus-icon"></i></div>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="itemRowRoom-item">
					<div class="input-group input-numeric">
						<div class="input-group-prepend">
						<div class="btn cubiertoNino" id="minus-btn" onclick="lessOne('#nino_`+a+`')"><i class="fa fa-minus fa-less-icon" ></i></div>
						</div>
						<div class="line-2"></div>
						<input type="number" id="nino_`+a+`" name="r`+a+`k" class="form-control  caja-number" value="0" min="0" max="2" readonly="">
						<div class="line-2"></div>
						<div class="input-group-prepend">
						<div class="btn cubiertoNino" id="plus-btn" onclick="plusOne('#nino_`+a+`')"><i class="fa fa-plus fa-plus-icon"></i></div>
						</div>
					</div>
				</div>
				</div>
			
				<div class="childrenYear edadNH_`+a+`_1" style="display:none">
				<div class="itemRowChild">
					<span>child's age 1</span>
				</div>
				<div class="itemRowChild">
					<select id="edadNH_`+a+`_1" name="r`+a+`k1a" class="edadninio obl item custom-select selecta form-control" disabled>
						<option value="-" selected>`+idioma.buscador.combo+`</option>
						<option value="0" >`+idioma.buscador.titulo8+`</option>`+years+`                                                
					</select>
				</div>                                                              
				</div>
				<div class="childrenYear edadNH_`+a+`_2" style="display:none">
				<div class="itemRowChild">
					<span>child's age 2</span>
				</div>
				<div class="itemRowChild">
					<select id="edadNH_`+a+`_2" name="r`+a+`k2a" class="edadninio obl item custom-select selecta form-control" disabled>
						<option value="-" selected>`+idioma.buscador.combo+`</option>
						<option value="0" >`+idioma.buscador.titulo8+`</option>`+years+`                                                       
					</select>
				</div>                                                              
			...
			$("#habitacion_" + a,"#habitaciones").show();	
			
			
		}
		$("#totalHab").val(maxrooms);
		if(maxrooms == 3){
			$("#habitacion_2 .eliminar").hide();
			$(".addHabi").hide();
	...
	$(document).on("click","#habitacion_2 .eliminar",function(e){
		console.log("borrar");
		$("#habitacion_2").remove();
		$("#rooms").val(1);
		$(".addHabi").show();
	...
	$(document).on("click","#habitacion_3 .eliminar",function(e){
		console.log("borrar2");
		$("#habitacion_3").remove();
		$("#rooms").val(2)
		$("#habitacion_2 .eliminar").show();
		$(".addHabi").show();
...
$(document).on("click","#habitacion_2 .eliminar",function(e){	
	console.log($("#adultos_2").val());
	var totalAdult = parseInt($("#numAdult").val());
	var totalAdult2 = parseInt($("#adultos_2").val());
	var totalninot2 = parseInt($("#nino_2").val());
	
	$("#numAdult").val((totalAdult-totalAdult2)-totalninot2);
});

$(document).on("click","#habitacion_3 .eliminar",function(e){	
	console.log($("#adultos_3").val());
	var totalAdult = parseInt($("#numAdult").val());
	var totalAdult3 = parseInt($("#adultos_3").val());
	var totalninot3 = parseInt($("#nino_3").val());
	
	$("#numAdult").val((totalAdult-totalAdult3)-totalninot3);
});
...
$(document).ready(function(e)
{
	...
	$(".addHabi").on("click",cambioHabitaciones);
	$(".addHabi").trigger('click');
	 ...
	 $(document).on("click", "#showMap", function(e){
		...
		$("#navFilter").addClass("fijoDiv");
	 	...
	 	if(models.openMap == false){
			...
			$(".filtrosHotelStar").addClass("mapaActivo");
    		...
    		e.preventDefault && e.preventDefault();
			 ...
			 $("#infoMaps").hide("slow");
			 $("#navFilter").removeClass("fijoDiv");
			//models.pintando=0;
			$(".divSection").removeClass("mapaActivo");
			$(".filtrosHotelStar").removeClass("mapaActivo");
	...
	/* $("#startDate").datepicker(
	{
		...
		onClose : function(selectedDate)
		{
			...
			$("#endDate").datepicker("option", "minDate",fecha);
		}
	});
					...
					response($.map(	data,
									function(item)
									{
										return{
											...
											category :(item.tipo==1 ? idioma.buscador.destination : idioma.buscador.hotels),
											value : item.ciudad,
	...
	$("#search").on("click",function(e)
	{
		...
		{			
			...
			$(".alertBad, .alertBad2, #frameContent, #destinosT, #mapita, #pest, #filtrosSection, #bannerT, #frame, #alertaResultados").hide();
			...
			$("#cerraBusqueda").hide();
			$(".encontrados").hide();
			$("#contenidoDiv").removeClass("col-lg-9")
			models.maquetaActual=models.hotels;
			$.ajax({
				...
				beforeSend: function(e) {
					...
					///Analytics
					let totalHab = $("#rooms").val();
					let totalNinos = 0;
					let totalAdultos = 0;
					for (let hab = 1; hab <= totalHab; hab++) {
						let totalNiHab = $("#nino_" + hab).val(); // Total de Niños por habitacion
						totalNinos = parseInt(totalNinos)+parseInt(totalNiHab);
						let totalAdult = $("#adultos_" + hab).val();
						totalAdultos = parseInt(totalAdultos)+parseInt(totalAdult);
					}
					datosBusqueda = {
						"Destino" 	: 	$("#destinoName").val(),
						"Checkin" 	: 	$("#startDate").val(),
						"Checkout"	: 	$("#endDate").val(),
						"Habitaciones":	$("#rooms").val(),
						"Adultos"	: 	totalAdultos,
						"Niños"		:	totalNinos										
				}

				datosBusqueda = JSON.stringify(datosBusqueda);
					datosAnalytics = ["Botón", datosBusqueda, 1];
					eventoAnalytics = _ga.asignaValores(datosAnalytics);
					_ga.envioEvento(_ga.tiposEvento[0],eventoAnalytics);
				...
				{		
					if(data==null || data=="" || data == {}){
						$("#frame2").hide();
						$(".alertGood,.alertBad, #alertaResultados").hide();
						$(".alertBad, #alertaResultados").show();
						// setTimeout(function() {$(".alertBad, #alertaResultados").hide();},4000);
...
/* 	$(document).on('change', ".cubiertoNino", function ()
	...
	$(document).on('click', ".cubiertoNino", function ()
	{
		...
		if(n == 0)
		{
			...
			$("#edadNH_"+h+"_1").attr('disabled','disabled').hide();
			$("#edadNH_"+h+"_2").attr('disabled','disabled').hide();
			$("#edadNH_"+h+"_1").val("-");
			$("#edadNH_"+h+"_2").val("-");
		...
		if(n == 1)
		{
			...
			$("#edadNH_"+h+"_1").removeAttr('disabled').show();
			$("#edadNH_"+h+"_2").attr('disabled','disabled').hide();
			$("#edadNH_"+h+"_2").val("-");
		...
		if(n == 2)
		{
			...
			$("#edadNH_"+h+"_1").removeAttr('disabled').show();
			$("#edadNH_"+h+"_2").removeAttr('disabled').show();
	...
	if(location.search!="")
	{
		...
		if(variables.ta=="sp")		
		{
			...
			models.token=0;
			models.destino="";
			models.maquetaActual=models.hotelsDirectorio;
			$.ajax(
			{
			...
			}).done(function(data)
			{
                ...
                beforeSend: function(e) {
					...
					for (let hab = 1; hab <= totalHab; hab++) {
						let totalNiHab = $("#nino_" + hab).val(); // Total de Niños por habitacion
						totalNinos = totalNinos+totalNiHab;
						let totalAdult = $("#adultos_" + hab).val();
						totalAdultos = totalAdultos+totalAdult;
					}
					datosBusqueda = {
						"Destino" 	: 	$("#destinoName").val(),
						"Checkin" 	: 	$("#startDate").val(),
					...
					datosBusqueda = JSON.stringify(datosBusqueda);
					datosAnalytics = ["Semanas premium", datosBusqueda, 1];
					eventoAnalytics = _ga.asignaValores(datosAnalytics);
					_ga.envioEvento(_ga.tiposEvento[0],eventoAnalytics);
			...
			}).done(function(data)
			{
               ...
               // $("#filtrosSection").hide();
                ...
                beforeSend: function(e) {
					...
					datosBusqueda = JSON.stringify(datosBusqueda);
					datosAnalytics = ["Properties/destinations", datosBusqueda, 1];
					eventoAnalytics = _ga.asignaValores(datosAnalytics);
					_ga.envioEvento(_ga.tiposEvento[0],eventoAnalytics);
                },
                complete:function(){
	...
	$(document).on("click",".destinoFF",function(e)
	{
		...
		else
		{
			e.preventDefault();
		//$(".alertGood").show();
		$(".alertBad2, .alertBad, #destinosT, #pest, #filtrosSection, #bannerT, #alertaResultados").hide();
		$("#contenedorHoteles").hide("slow");
		var id=$(this).prop("id");
		...
		$.ajax({
			...
			datosBusqueda = JSON.stringify(datosBusqueda);
				datosAnalytics = ["Top destinations", datosBusqueda, 1];
				eventoAnalytics = _ga.asignaValores(datosAnalytics);
				_ga.envioEvento(_ga.tiposEvento[0],eventoAnalytics);
	        },
		    complete:function(){		        
	...
	$(document).on("click",".validarRadio",function()
	{
		...
		if( $('input[name="habitacion_'+v+'_'+codigoHotel+'"]').is(':checked') )
		{
			...
			actual.find('.itemRoomRes').removeClass("activaItemT");
			var item = $(this).closest(".itemRoomRes");
			if( datox[4] == "S" )
			{	
	...
	$(document).on("click",".info",function(){
		...
		if (url == "tarifasstays"){
			...
			if(accion == "show"){
				...
				$(".map-working"+val).slideDown();
				$("#b"+val+"tarifas").addClass("activo");
				$.ajax({
					type: "POST",
					url: models.url+"_assets/_controllers/tarifasRes.php",
					data: {"code" : val},	
					dataType:"text",
			...
			$("#hotelito_"+val).addClass("fixedMobile");
		...
		/* 	function is_touch_device()
			...
			var navs = document.querySelectorAll('.scroll'+val);
			...
			$('.flickity-slider .btabstab ').click(function(){
				
				$('.btabstab').removeClass("activoRes");
				$(this).addClass("activoRes");
			  });
			...
			$.ajax({
				...
				success:function(texto){
					...
					var content = $('#popup_hotel').html();
					$("#infoMaps").html(content);
					infowindow.close();
					$("#infoMaps").show();

					$(".btabs"+val).removeClass("activo");
					$("#"+pref+"b"+val+url).addClass("activo");
					$("."+val+url).addClass("activo");
    ...
    if(($( document ).height()-$(window).scrollTop())< ($( window ).height()+72)) {
...
models.dibujaHoteles=function(){
	...
	for( ;i<(models.itemsActual+models.items) && i<models.itemsTotal;i++){
		...
		if(hotel.id == 0)
			break;
	    $("#listado").append(common.toDraw(models.maquetaActual,hotel));
	...
	$("#frame2").hide();
	$("#listado").show();
	$("#modColum").addClass("row");
	$("#cajaReserva").addClass("col-lg-3").show();
	$("#contenidoDiv").addClass("col-lg-9");
	$(".encontrados").show();
	$("#startDate").datepicker( "destroy" );
	$("#endDate").datepicker( "destroy" );
	$(".otrosFiltros").show();
	$(".divBuscador").attr('id', 'navFilter');

	var width = $(window).width();
	if( width < 992){
		$(".encontradosMobile").show();
	}
...
models.convertirEstrella =function( estrella ){
        ...
        media = '<i class="fa fa-star-half-o" aria-hidden="true"></i>';
...
models.cargadescripcion= function (i){
	...
	if(hotel.HotelDescription == ""){
		$.ajax(
			{
				url:models.url+"_assets/_controllers/buscadorHotelDetalles.php?Code="+hotel.code+"&HotelProvider="+hotel.BookingSource+"&Id="+hotel.id+"&net="+models.net+"&destino="+models.cityCode,
				dataType:"json",
				method :"POST",
				...
				success: function(data){ 
					...
					$(".descrip","#hotelito_"+data.code).html(temp);
					$(".description","#hotelito_"+data.code).html(temp);
				...
				for (var i = data.hoteles.length - 1; i >= 0; i--) {
					...
					hotel.precioPublicoTextF="";
					 if(hotel.porcentajeAhorro>15 ){
						...
						hotel.save='<div class="save"> <span>Save '+hotel.porcentajeAhorro+'%</span> <span  class="izq">'+hotel.precioReward+'</span></div> ';
						hotel.nuevoPrecio='<div class="public"><span>Public Price</span> <span  class="izq">'+hotel.precioPublicoTextF+'</span></div>'
...
models.validacargaHoteles = function(){
	if(models.hotelesSecciones[0].length == 0){
		...
		setTimeout(function(){
			...
			models.progressStatus = false;
			$("#loading, #frame2").hide();
			if((models.hotelesSecciones.length>1 && models.hotelesSecciones[1].length==0)|| models.hotelesSecciones.length==1)
				models.listaActual=models.hotelesSecciones[0];
...
models.showMapDos = function(){
	...
	r.forEach(function(val, key){
		...
		var iconM = val.porcentajeAhorro > 20 ? '_assets/_images/ubicacion1.png' : '_assets/_images/ubicacion2.png';
...
$(document).on("click", ".my-add-button", function(e){
	///Analytics
	let totalHab = $("#rooms").val();
	let totalNinos = 0;
	let totalAdultos = 0;
	for (let hab = 1; hab <= totalHab; hab++) {
		let totalNiHab = $("#nino_" + hab).val(); 
		totalNinos = parseInt(totalNinos)+parseInt(totalNiHab);
		let totalAdult = $("#adultos_" + hab).val();
		totalAdultos = parseInt(totalAdultos)+parseInt(totalAdult);
	}
	
	let hotelCode = $(this).data("c");
	let nombreHotel = $(`#hotelito_${hotelCode} .hotel .contprin .contenedor_informacion_centro .header .titles .nombre`).text();
	let fechasReserva = $(`#hotelito_${hotelCode} .hotel .contprin .contenedor_informacion_centro .header .titles .fechas`).text();
	let aplicaRW = $(`.ARW_${hotelCode} .ARW`).val() == 1 ? "Si aplica" : "No Aplica";
	let found = models.listaActual.find(function(element){return element.id==hotelCode;});
	let bundled = found.Bundled == "S" ? "Sí" : "No"; 
	
	let padre = document.querySelector(`#mostrar${hotelCode} .contenedorHabitaciones`);
	let totalOpciones = padre.querySelectorAll('.contenedorIndividual');
	let datosHabitaciones = [];
	let table = "";
		if(totalOpciones.length>0){

			for(let i= 1; i<=totalOpciones.length; i++){
				table = $(`#mostrar${hotelCode} .contenedorHabitaciones .hab_${i} .itemRoomRes`);
				let selected = table.find(":checked");
				let column = selected.parent().parent();
				console.log(column);
				let datosHabitacion = {
					"Tipo habitación"	: column.find(".rDes")[0].innerText,
					"Plan alimentos" 	: column.find(".rPlan")[0].innerText,
					"Public price"		: column.find(".rPTotal")[0].innerText,
					"Rewards"			: column.find(".rPreward")[0].innerText,
					"Precio members"	: column.find(".rPsocio")[0].innerText 
				}
				datosHabitaciones.push(datosHabitacion);
			}

		}else{
			table = $(`#mostrar${hotelCode} .contenedorHabitaciones`);
			let selected = table.find(":checked");
			let column = selected.parent().parent();
			let datosHabitacion = {
				"Tipo habitación"	: column.find(".rDes")[0].innerText,
		...
		let totalFinal = 0;
		 datosHabitaciones.forEach(function(element){
			 if(aplicaRW=="Si aplica"){
				let precio = element["Precio members"];
				precio = precio.replace("$","");
				precio = precio.replace("€","");
				totalFinal = parseFloat(totalFinal)+parseFloat(precio);
			 }else{
				let precio = element["Public price"];
				precio = precio.replace("$","");
				precio = precio.replace("€","");
				totalFinal = parseFloat(totalFinal)+parseFloat(precio);
			 }
		...
		var datosHotel = {
			...
			"Adultos"	: 	totalAdultos,
			"Niños"		:	totalNinos,
			"Aplica Rewards": aplicaRW,
			"Num. Habitaciones" : totalHab,
			"Bundled"	: bundled,
			"Datos Habitacion" : datosHabitaciones,
			"Total final":	totalFinal										
		}

		datosHotel = JSON.stringify(datosHotel);
		let datosAnalytics = ["Subida carrito", datosHotel, 1];
		let eventoAnalytics = _ga.asignaValores(datosAnalytics);
		_ga.envioEvento(_ga.tiposEvento[4],eventoAnalytics);
...
$(document).on("click", ".scDelete", function(e){
	let hotel = $(this).parent().parent();
	// let hotelCode = $(this).children().attr("href");
	// hotelCode = id_hotel.replace("?jcartRemoveHotelNet=","");
	let datosHabitaciones = [];

	let habitacion1 = {
		"Tipo habitación"	: hotel.children()[3].children[0].innerText,
		"Habitación"		: hotel.children()[4].children[1].innerText,
		"Total"				: hotel.children()[5].children[1].innerText,
		"Rewards" 			: hotel.children()[5].children[3] == undefined ? "No aplico RW" : hotel.children()[5].children[3].innerText,
		"Total members"		: hotel.children()[5].children[5] == undefined ? "No aplica" : hotel.children()[5].children[5].innerText
	}	
	datosHabitaciones.push(habitacion1);

	if(hotel.children()[6].children[0] != undefined){
		let habitacion2 = {
			"Tipo habitación"	: hotel.children()[6].children[0].innerText,
			"Habitación"		: hotel.children()[7].children[1].innerText,
			"Total"				: hotel.children()[8].children[1].innerText,
			"Rewards" 			: hotel.children()[8].children[3] == undefined ? "No aplico RW" : hotel.children()[8].children[3].innerText,
			"Total members"		: hotel.children()[8].children[5] == undefined ? "No aplica" : hotel.children()[8].children[5].innerText
		}	
		datosHabitaciones.push(habitacion2);
	}

	if(hotel.children()[6].children[0] != undefined){
		let habitacion3 = {
			"Tipo habitación"	: hotel.children()[9].children[0].innerText,
			"Habitación"		: hotel.children()[10].children[1].innerText,
			"Total"				: hotel.children()[11].children[1].innerText,
			"Rewards" 			: hotel.children()[11].children[3] == undefined ? "No aplico RW" : hotel.children()[11].children[3].innerText,
			"Total members"		: hotel.children()[11].children[5] == undefined ? "No aplica" : hotel.children()[11].children[5].innerText
		}	
		datosHabitaciones.push(habitacion3);
	}
	
	
	let datosHotel = {
		"Hotel"			: hotel.children()[0].children[2].innerText,
		"Checkin"		: hotel.children()[1].children[1].innerText,
		"Checkout"		: hotel.children()[2].children[1].innerText,
		"Habitaciones"	: datosHabitaciones,
		// "Total final"	: hotel.children()[9].children[1].innerText	
	}
	datosHotel = JSON.stringify(datosHotel);
		let datosAnalytics = ["Elimina carrito", datosHotel, 1];
		let eventoAnalytics = _ga.asignaValores(datosAnalytics);
		_ga.envioEvento(_ga.tiposEvento[9],eventoAnalytics);
...
$(document).ready(function(e){
	...
	$('#navFilter').css('height', windowHeight + 'px');
	...
	$(document).on('click touchstart', '#showMenu', function(){
		...
		/* $('#navFilter').css('left', '0'); */
		$('#navFilter').removeClass('ocultamenu');
		$('#navFilter').addClass('muestramenu');

		$('#showMenu, #hideMenu').css('left', '211px');
		$('#showMenu, #hideMenu').html('<i class="fa fa-chevron-left"></i>');
		$('#showMenu').attr('id', 'hideMenu');
	});

	$(document).on('click touchstart', '#hideMenu', function(){
		$('#navigation-hover').hide();

		/* $('#navFilter').css('left', '-211px'); */
		$('#navFilter').removeClass('muestramenu');
		$('#navFilter').addClass('ocultamenu');

		$('#showMenu, #hideMenu').css('left', '0');
		$('#showMenu, #hideMenu').html('<i class="fa fa-chevron-right"></i>');
		$('#hideMenu').attr('id', 'showMenu');
	});

	$(document).on("click",".verDetallesH",function(e){
		e.preventDefault();
		var actual = $(this);

		var padre = actual.closest(".contenedorHotelesBusqueda ");
		    padre.find(".ultratabs").show();
		    padre.find(".contenedor_interno").hide(200);
		    $('body').css('overflow','hidden');	
	});

	$(document).on("click",".nombreTab",function(e){
		e.preventDefault();
		var actual = $(this);
	
		var padre = actual.closest(".contenedorHotelesBusqueda ");
		    padre.find(".ultratabs").hide();
		    padre.find(".contenedor_interno").show(200);
		    padre.removeClass("fixedMobile");
	...
	new Lightpick({
		...
		//maxDate: moment().endOf('day').add(31, 'day'),
		maxDays: 30,
	  ...
	  $(document).on("click","#infoMaps .nombreTab",function(e){  
		 $("#infoMaps").hide();
		 $("#mapHoteles").show();
	  });
...
function plusOne(dato){
	...
	var tot =   parseFloat($("#numAdult").val());
	let valor=$(dato).val();
  ...
  $('.itemRowRoom-item :input').change(function() {
	var tot = 0;
	$(".itemRowRoom-item :input").each(function() {
	  tot += +this.value;
	});
	$('#numAdult').val(tot);
    });
