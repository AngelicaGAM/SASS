...
function LastMinute( dia=90 )
{
	...
	$.ajax(
	{
		url		: "_assets/_controllers/getLastMinutePremiumWeeksPlus.php",
		type	: "POST",
		data	:
		{ 
			dia : dia, 
...
function premiumWeeksPlusChronosoft()
{
	...
	$.ajax({
		url		: "_assets/_controllers/getLastMinutePremiumWeeksPlusChronosoft.php",
		type	: "POST",
		data	:
		{ 
			dia : null, 
		...
		success : function(data)
		{
			...
			{
				loadingHtml		 : '<div style="margin: 1em auto; width: 1022px;"><div style="width: 150px; height: auto; margin: 0 auto; margin-top: 2em;"><img src="_assets/_images/template/loading.gif" class="loading" width="150" /></div></div>',
			    padding			 : 0,
			    autoTrigger		 : true,
			    callback		 : function()
			    {
						...
						$( ".ocultado" ).each(function( index,value )
						{
						    ...
						    if( (index+1) <= cantidadReal)
							{
								if(!$(value).hasClass("mostrado"))
								{
									...
									$(value).delay(300*index).fadeIn("fast",function()
									{
